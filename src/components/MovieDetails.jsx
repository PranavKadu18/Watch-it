    ...
    >
      ...
      <div className="flex w-full min-h-[50vh] text-white">
            ...
            <div className="pl-12">
              ...
              <Link to={`/movie/details/${info.external_id.id}/trailer`} className="px-4 py-1 mt-4 w-fit bg-[#6556CD] rounded-md flex items-center gap-2">
