...
const Card = ({info,type}) => {
  ...
  return (
    <Link to={`/${info.media_type || type}/details/${info.id}`} className='w-[13vw] h-[34vh] shrink-0 hover:z-50 transition-all ease-in-out duration-700  rounded-md hover:scale-150 bg-[#16181F] overflow-hidden relative group'>
