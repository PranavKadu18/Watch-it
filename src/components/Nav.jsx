...
const Nav = () => {
  ...
  return (
    <div className="relative w-full mt-1 h-[9vh] px-4 flex items-center justify-start pl-[10%] gap-4">
      <i
      ...
      <div className="w-[48%] max-h-[38vh] z-10 bg-white absolute top-[90%] overflow-auto rounded">
        {search.map((elem,idx) => (
          <NavLink key={idx} className="inline-block flex gap-8 items-center z-10 font-semibold w-full p-4 bg-zinc-300 text-sm border-b-2 hover:bg-[#8e83d8]">
            ...
            <h1>{elem.original_title || elem.title || elem.title}</h1>
          </NavLink>
        ))}
      </div>
    </div>
